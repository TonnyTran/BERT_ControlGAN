...
from model_BERT import G_DCGAN, G_NET
from datasets_BERT import prepare_data
from model_BERT import BERT_ENCODER, CNN_ENCODER
...
class condGANTrainer(object):
    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.max_epoch):
            start_t = time.time()
            print("Epoch " + str(epoch) + "/" + str(self.max_epoch))
            ...
            while step < self.num_batches:
                ...
                if gen_iterations % 100 == 0:
                    print(">>>>>>>>>>>>Epoch: " + str(epoch) + "/" + str(self.max_epoch) + " - Iteration: " + str(gen_iterations))
                    print(D_logs + '\n' + G_logs)
